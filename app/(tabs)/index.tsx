...
//           // Show ALL unread notifications (not just the first one)
...
//                   onPress: async () => { 
//                     await fetch(
//                       `https://backendiotproject-c4gbdtdqcebjb9c9.spaincentral-01.azurewebsites.net/api/device/mark-read/${notif.id}`,
//                       {
//                         method: "POST",
//                         headers: { 
//                           Authorization: `Bearer ${token}`,
...
function RoomCard({ id, title }) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.roomFooter}>
        <Ionicons name="thermometer-outline" size={18} color="#fff" />
        <Ionicons name="wifi-outline" size={18} color="#wifi" />
      </View>
    </TouchableOpacity>
  );
}
